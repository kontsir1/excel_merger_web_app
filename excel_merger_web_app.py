...
def main():
    ...
    if df1 is not None:
        ...
        # Change column name
        column_to_change = df_merged.columns[st.sidebar.selectbox("Select column to change its name", df_merged.columns)].name
        ...
        # Export selected columns of dataframe as CSV and XLSX
        selected_columns = st.multiselect("Select columns to export", df_merged.columns, default=df_merged.columns)
