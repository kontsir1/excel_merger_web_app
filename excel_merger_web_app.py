    ...
    if file_one and file_two:
        ...
        if file_one_ext in ['csv', 'xlsx']:
            if file_one_ext == 'csv':
                ...
                df1 = pd.read_csv(file_one, skiprows=header_row_file1-1, skipinitialspace=True, sep=' ')
            else:
        ...
        if file_two_ext in ['csv', 'xlsx']:
            if file_two_ext == 'csv':
                ...
                df2 = pd.read_csv(file_two, skiprows=header_row_file2-1, skipinitialspace=True, sep=' ')
            else:
