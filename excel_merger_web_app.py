    ...
    if file_one and file_two:
        ...
        if file_one_ext in ['csv', 'xlsx']:
            if file_one_ext == 'csv':
                ...
                try:
                    df1 = pd.read_csv(file_one, skiprows=header_row_file1-1, skipinitialspace=True, delim_whitespace=True, delimiter=r"\s+")
                except:
        ...
        if file_two_ext in ['csv', 'xlsx']:
            if file_two_ext == 'csv':
                ...
                try:
                    df2 = pd.read_csv(file_two, skiprows=header_row_file2-1, skipinitialspace=True, delim_whitespace=True, delimiter=r"\s+")
                except:
